...
folder_with_pdbs="../inputs/my_structures/5UOI/my_samples/" #directs to 5uoi sample

output_dir="../outputs/my_variants"
if [ ! -d $output_dir ]
then
    mkdir -p $output_dir
fi

python3 ../helper_scripts/convert_cif_to_pdb.py
...
design_only_positions="18 19 20 23 26 27" #design only these residues; use flag --specify_non_fixed
